...
function SvgBookClose(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" {...props}>
      ...
      <g id="bookClose_svg__\uB808\uC774\uC5B4_2" data-name="\uB808\uC774\uC5B4 2">
        <g id="bookClose_svg__\uB808\uC774\uC5B4_1-2" data-name="\uB808\uC774\uC5B4 1">
          ...
          />
          <path className="bookClose_svg__cls-3" d="M31.5 35.67V14.84a2 2 0 00-1.1-1.78L10.45 3" />
        </g>
      </g>
    </svg>
  );
