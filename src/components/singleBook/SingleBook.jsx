...
const SingleBook = ({ datas, searchBar, title }) => {
  ...
  const handleBookNavigate = (id) => {
    ...
    if (childStat && (title === "Trending Books" || title === "New Releases Books" || title === "Classic Books")) {
  ...
  return (
    <div className="lib-book-gallery">
      ...
      <div className={childStat && (title === "Trending Books" || title === "New Releases Books" || title === "Classic Books")? "lib-book-gallery-wrapper-opacity" : "lib-book-gallery-wrapper"}>
          ...
          {datas.length !== 0 ? (
            datas.map((data) => {
              return (
                  ...
                  <div className="lib-gallery-box" onClick={() => handleBookNavigate(data.id)} key = {data.id}>
