...
const WalletWithdraw = ({data}) => {
  ...
  return (
    <div className='wallet-withdraw-container'>
        ...
        <p>Minimum  Withdrawal Amount : <b>₦{data.min_withdrawal_amount}</b></p>
        <p>Maximum  Withdrawal Amount : <b>₦{data.max_withdrawal_amount}</b></p>
        ...
        <input
                ...
                <button disabled={formState.buttonState} onClick={() => handleSubmit() } className='submit-amount-btn'>
