...
const WalletAccountDetails = () => {
    ...
    const { allBanks, addBankSuccess, addBankFailure, walletDetails  } = useSelector((state) => state.profile);
    ...
    <div className='wallet-account-container'>
        ...
        />  
          ...
          <input
                ...
                <button disabled={formState.buttonState} onClick={() => handleSubmit() } className='submit-account-btn'>
