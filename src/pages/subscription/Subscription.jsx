    ...
    <div className="subscription-page-container">
      <div className="subscription-top-contents">
        <div className="subscription-image-container">
          ...
          <button className='trial-btn' onClick={(e) => payWithPaystackTrial(e)}>Get 7 days access to the Trial period for ₦100 </button>
          <p className='subscription-top-text'>Please note that the sum of ₦100 will be deducted from your account, this is to validate your account.</p>
      </div>
      ...
      <div className="subscription-bottom-contents">
          ...
          <div className="subscription-plan-card-wrapper">
              <div className="subscription-card">
                ...
                <p className='subscription-price'>₦1000/<span>1 month</span></p>
                <p className='price-subtext'>Great Reading Plan for Individual</p>
                <p className='features-list'><AiFillAlert color='green'/> Access to a vast repository of books</p>
                <p className='features-list'><AiFillAlert color='green'/> Sync reading accross all devices</p>
                <p className='features-list'><AiFillAlert color='green'/> Get the latest book releases</p>
                <p className='features-list'><AiFillAlert color='green'/> One (1) Number of Devices</p>

                <button className='trial-btn'  onClick={(e) => payWithPaystackMonthly(e)} >Subscribe</button>
              ...
              <div className="subscription-card">
                ...
                <p className='subscription-price'>₦2,500/<span>3 month</span></p>
                <p className='price-subtext'>Great Reading Plan for Individual</p>
                <p className='features-list'><AiFillAlert color='green'/> Access to a vast repository of books</p>
                <p className='features-list'><AiFillAlert color='green'/> Sync reading accross all devices</p>
                <p className='features-list'><AiFillAlert color='green'/> Get the latest book releases</p>
                ...
                <button className='trial-btn' onClick={(e) => payWithPaystackQuarterly(e)}>Subscribe</button>
             ...
             <div className="subscription-card">
                ...
                <p className='subscription-price'>₦5,500/<span>6 month</span></p>
                <p className='price-subtext'>Great Reading Plan for Individual</p>
                <p className='features-list'><AiFillAlert color='green'/> Access to a vast repository of books</p>
                <p className='features-list'><AiFillAlert color='green'/> Sync reading accross all devices</p>
                <p className='features-list'><AiFillAlert color='green'/> Get the latest book releases</p>
                ...
                <button className='trial-btn' onClick={(e) => payWithPaystackBiannual(e)}>Subscribe</button>
             ...
             <div className="subscription-card">
                ...
                <p className='subscription-price'>₦11,200/<span>12 month</span></p>
                <p className='price-subtext'>Great Reading Plan for Individual</p>
                <p className='features-list'><AiFillAlert color='green'/> Access to a vast repository of books</p>
                <p className='features-list'><AiFillAlert color='green'/> Sync reading accross all devices</p>
                <p className='features-list'><AiFillAlert color='green'/> Get the latest book releases</p>
                ...
                <button className='trial-btn' onClick={(e) => payWithPaystackAnnual(e)}>Subscribe</button>
