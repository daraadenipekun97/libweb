...
import { userLogin, restoreUserLoginInitial, googleLogin, restoreGoogleLoginSuccessInitial } from "../../Actions";
...
const LoginPage = ({user}) => {
  ...
  const { loginSuccess, loginFailure, googleLoginSuccess, googleLoginFailure } = useSelector((state) =>state.auth);
