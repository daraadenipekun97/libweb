    ...
    <div className='lib-download-app-container'>
        <div className="lib-download-app-wrapper">
            <div className="lib-download-app-left-content">
                ...
                <a href="https://play.google.com/store/apps/details?id=com.libribooks" className='lib-store' target = "_blank" rel="noopener noreferrer">
                   <div className="lib-store-wrapper">
