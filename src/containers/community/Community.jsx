  ...
  return (
    <div className='lib-community-wrapper'>
        ...
        <div className="lib-community-left-wrapper">
            ...
            <p>Rub mind with a community of readers just like yourself and get more insights into trending books</p>
            <a href='https://www.facebook.com/groups/5205409852862649' className="lib-community-btn" target = "_blank" rel="noopener noreferrer">Get Started</a>
        </div>
